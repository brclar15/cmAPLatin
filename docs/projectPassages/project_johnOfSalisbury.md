...
The passage’s text is drawn from [J.P. Migne’s](https://en.wikipedia.org/wiki/Jacques_Paul_Migne) _[Patrologia Latina](https://en.wikipedia.org/wiki/Patrologia_Latina)_ (1855) on the University of Zurich’s _Corpus Corporum_ ([mlat.uzh.ch](mlat.uzh.ch)) and edited for classroom use.
